...
**Worked illustration (VUZI):** Vuzix — POV and business case (illustration)) — полный GTM-флоу: MDP, POV, metrics, unit economics (`12k × $5`), business case, exec checklist (illustration only). **Глоссарий** — в начале того же файла.
