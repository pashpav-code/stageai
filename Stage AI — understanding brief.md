...
| **S7** | **Snapdragon / Android on-device only** | APK или on-glass, без iOS path | ❌ self-serve on-device | Только **S1** cloud или wait |

*S7 исключение:* Huawei-style **кастом** — не масштабируемый ICP.
...
| TheStage | Полный phone path | ⚠️ Только **phone path** | ❌ on-device; maybe **S1** cloud |
...
**Prospects (не paying, для сравнения):** **Vuzix** (S7→W3) — **🕶️** voice on AR1 chip + **☁️** partner/R&D cloud (TheStage = **☁️** only) · **RealWear** — то же W3-паттерн.
...
| **W3** | Wearable + voice, пока **cloud** | S7→S1 | RealWear, Vuzix (список B) | cloud NVIDIA; «unlock» later |
...
3. **iOS companion?** нет → не обещать S3/S4 on-device  
